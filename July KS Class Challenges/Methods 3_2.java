...
class YoutubeVideos{
    ...
    public void setProp(String song,String artist,int views,int likes,int releaseYear,int n,ArrayList<String>arr){
        this.song=song;
        this.artist=artist;
        this.views=views;
        this.likes=likes;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        obj.setProp(song,artist,views,likes,releaseYear,n,arr);
